    ...
    return (
        <div>
            <div className='border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hidden group transition'>
                ...
                <div className='absolute top-6 -right-11 group-hover:right-5 p-2 flex flex-col items- justify-center gap-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300'>
